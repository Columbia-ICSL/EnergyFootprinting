...
class DBInit(object):
    ...
    def WriteConfigs(self):
        ...
        addRoom("nwc10_hallway", "NWC 10F Hallway", [0,0], PUBLIC_SPACE, GENERAL_SPACE, NOT_WINDOWED)
        addRoom("nwc1003b_danino", "Danino Wet Lab Space", [0, 0], DANINO_LAB, STUDENT_WORK_SPACE, WINDOWED)
	...
	addAppliance("testDevice", "Aeon Labs Smart Switch 6 testings", "Electrical", "nwc1003b_c", ACTIONABLE, NO_DUTY_CYCLE)
        ...
        addAppliance("nwc1000m_a6_plug_3", "Power strip #3  in Mezzaine Level, Aisle #6", "Electrical", "nwc1000m_a6", ACTIONABLE, NO_DUTY_CYCLE)
        addAppliance("nwc1000m_a6_plug_4", "Power strip #4  in Mezzaine Level, Aisle #6", "Electrical", "nwc1000m_a6", ACTIONABLE, NO_DUTY_CYCLE)
